...
<body data-animation-in="fadeIn"  data-animation-out="fadeOut" data-icon="12" data-icon-color="#76aa00" data-speed-in="1000" data-speed-out="500">
    ...
    <div class="wrapper">
		...
		<c:if test="${ board != null }">
			<form name="updateGo" action="goUpdateBoard" method="get"> 
			  ...
			  <div class="container bgc"> 
			    ...
			    <div class="row" style="color: red;" >
			    	<div class="col-lg-2">
			    		...
			    		<p class="text-small text-center" style=""><fmt:formatDate value="${parsedInputdate}" pattern="yyyy-MM-dd" /></p>
			    	</div>
			    	<div class="col-lg-2">
			    	...
			    	<div class="col-lg-2">
			    		<div class="icon-box effect small center">
			    			<c:if test="${LiketoVo==null}">
					    		<form name="go"> <input type="hidden" name="board_num" value="${board.board_num}"> 
					    	...
					    	<c:if test="${LiketoVo!=null}">
					    		<form name="to">
					    			...
					    			<div class="icon"> <a href="javascript:to()"><i class="fa fa-heart text-pink" ></i></a> </div>
								</form>
					    	</c:if>
			    		</div>
			    	</div>
			    ...
			    <div class="row">
			    	<div class="col-lg-10">
			    		<div class="blockquote">
			    			<p>내용</p>
							<c:if test="${ board == null }"><textarea name="board_content" rows="8" cols="100"></textarea></c:if>
							<c:if test="${ board != null }"><pre>${board.board_content}</pre></c:if>
						</div>
			    	</div>
			    </div>
	                        ...
	                        <div class="row">
	                            <div class="col-lg-12">
	                                <div class="form-group">
	                                    ...
	                                    <textarea class="form-control required bg-white" name="comments_content" rows="9" placeholder="Enter comment" id="comment" aria-required="true"></textarea>
	                                </div>
	                            </div>
	                        </div>
	                        <div class="row">
			    ...
			    <c:if test="${ board == null }">
				    <div class="text-center m-3">
						<input type="button" class="btn" onclick="write()" value="글등록" ></button>
					</div>
				</c:if>
				<c:if test="${sessionScope.user_id==board.user_id}">
					<div class="row">
						<div class="col-lg-12">
							<form name="forms" ><input type="hidden" name="board_num" value="${board.board_num}">
							    <div class="text-center m-3">
									<input type="button"  class="btn m-3" onclick="goUpdate()" value="글수정"></button>
									<input type="button"  class="btn m-3" onclick="goDelete()" value="삭제"></button>
									<input type="button"  class="btn m-3" onclick="goReturn()" value="목록"></button>
								</div>
							</form>
						</div>
					</div>
